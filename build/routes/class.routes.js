...
classRouter.get("/api/class/:name", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _class;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Class_1["default"].findOne({ name: req.params.name })];
            case 1:
                _class = _a.sent();
                if (!_class)
